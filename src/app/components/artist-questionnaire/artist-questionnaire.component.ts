...
export class ArtistQuestionnaireComponent {
  ...
  profileDraft = signal<UserProfile>({
    ...
    genreSpecificData: this.userProfileService.profile().genreSpecificData || {},
  ...
  questions: Question[] = [
    ...
    },
    {
      ...
      options: ['Boom Bap', 'Trap', 'Drill', 'Conscious', 'Melodic', 'Experimental'],
    ...
    },
    {
      ...
      description: 'How deep into the circuitry do you go? (1 = Presets, 10 = Modular/Custom)',
