export const CHATBOT_COMMANDS = [
  { command: 'AUTO_MIX', description: 'Analyze track and apply production secrets.' },
  { command: 'LEAD_BAND', description: 'Command AI session musicians with specific cues.' },
  { command: 'CRITIQUE_VISUALS', description: 'Brutal, brand-aligned feedback on artwork.' },
