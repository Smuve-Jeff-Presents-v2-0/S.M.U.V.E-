...
export class ChatbotComponent implements OnInit, AfterViewChecked {
  ...
  ngOnInit() {
    this.messages.set([
      {
        role: 'assistant',
        text: 'S.M.U.V.E 2.0 Online. Neural intelligence protocols initialized across production, marketing, and business domains. How shall we dominate the industry today? Type a command or ask anything.',
        timestamp: Date.now(),
        category: 'system',
      },
    ]);
